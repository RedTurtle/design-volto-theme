...
export {
  RichTextRender,
  richTextHasContent,
} from '@italia/components/ItaliaTheme/View/Commons/RichTextRender';

export RenderBlocks from '@italia/components/ItaliaTheme/View/Commons/RenderBlocks';
...
export LocationItem from '@italia/components/ItaliaTheme/View/Commons/LocationItem';
export LocationsMap from '@italia/components/ItaliaTheme/View/Commons/LocationsMap';
...
export PaginaArgomentoPlaceholderAfterRelatedItems from '@italia/components/ItaliaTheme/View/PaginaArgomentoView/Placeholder/AfterRelatedItems';
